								...
								@endif
									<input type = "hidden" name="merchant_id" value="<?php echo $user_id; ?>">
									 <!--<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {{Form::text('address', null, ['class'=>'form-control required', 'placeholder'=>'Merchant Address', 'autocomplete' => 'off'])}}
                                        </div>
                                    </div>-->
									<?php global $vouchers; ?>
									<div class="form-group">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {{Form::select('amenitie_id[]',$amenitie, null, ['empty'=>'Select Amenities','class'=>'form-control ','multiple'=>'multiple', 'autocomplete' => 'off'])}}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                   ...
                                   <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {{Form::text('discount', 0, ['class'=>'form-control required number', 'min'=>'1','max'=>'99', 'placeholder'=>'Discount', 'id'=>'discount', 'autocomplete' => 'off','onkeyup' => 'getprice()'])}}
                                        </div>
                                    </div>
                                    <div class="form-group">
