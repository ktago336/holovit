                            ...
                            {{ Form::open(array('method' => 'post', 'id' => 'registerform', 'class' => 'form form-signin')) }}
								...
								<div class="form-group"> 
                                    <div class="Groupon_clone">
                                       <i class="fa fa-gift" aria-hidden="true"></i>
                                        {{Form::text('voucher_number', null, ['id'=>'verify_contact', 'class'=>'form-control required', 'placeholder'=>'Enter voucher ID eg: LSGOV1111', 'autocomplete'=>'OFF'])}}
                                ...
                                <div class="form-group">
                                    <div class="Groupon_clone_button">
                                        {{Form::submit('Redeem', ['class' => 'btn btn-primary', 'onclick'=>'return checkForm()'])}}
                                        <div class="sin-txt">Go to the Orders <a href="{{URL('/merchant/myorders')}}">Cancel</a></div>
                                    </div>
                                </div>
                            {{ Form::close()}}
                        </div>
