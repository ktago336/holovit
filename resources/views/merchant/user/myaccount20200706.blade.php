                                ...
                                <div class="informetion_top">
                                   ...
                                   {{Form::model($recordInfo, ['method' => 'post', 'class' => 'form form-signin', 'id' => 'loginform','enctype' => "multipart/form-data"]) }}    
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                           {{Form::text('busineess_name', null, ['id'=>'busineess_name', 'class'=>'form-control required', 'placeholder'=>'Business Name', 'autocomplete'=>'OFF'])}}
                                        </div>
                                    </div>
									<div class="form-group">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                           {{Form::text('zipcode', null, ['id'=>'zipcode', 'class'=>'form-control required', 'placeholder'=>'Zipcode', 'autocomplete'=>'OFF'])}}
                                        </div>
                                    </div>
									<div class="form-group">
									...
									<div class="form-group">
                                          <label class="col-sm-3 control-label">Select Service <span class="require">*</span></label>
                                          <div class="col-sm-9" >
                                              <?php
                                                  $vall = '';
                                                  $cnt=0;
                                                  ...
                                                  if(isset($recordInfo->service_ids) && $recordInfo->service_ids!='' && $recordInfo->service_ids!=0 ){
                                                      ...
                                                      $selectedservicesbystaf=Service::whereIn('id', $convert_to_array)->where('is_deleted',0)->get();
									...
									<div class="form-group">
                                        <label class="col-sm-3 control-label">Google+ Link <span class="require"></span></label>
                                        <div class="col-sm-9">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            {{Form::text('name', null, ['id'=>'name', 'class'=>'form-control required', 'placeholder'=>'Name', 'autocomplete'=>'OFF'])}}
                                        </div>
                                    </div>
