            ...
            <div class="form-horizontal">
                <div class="box-body">
                        ...
                        <div class="col-sm-10">
                            {{Form::file('category_image', ['class'=>'form-control', 'accept'=>IMAGE_EXT])}}
                             ...
                             @if($recordInfo->category_image != '')
                                <div class="showeditimage">{{HTML::image(CATEGORY_SMALL_DISPLAY_PATH.$recordInfo->category_image, SITE_TITLE,['style'=>"max-width: 100px"])}}</div>
                                <div class="help-text"><a href="{{ URL::to('admin/categories/deleteimage/'.$recordInfo->slug.'?return='.Request::url())}}" title="Cancel" class="canlcel_le"  onclick="return confirm('Are you sure you want to delete?')">Delete Image</a></div>
                             @endif
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ URL::to( 'admin/categories/subsubcategories/'.$parentInfo->slug)}}" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
                    </div>
                </div>
            </div>
            {{ Form::close()}}
