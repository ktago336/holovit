            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="{{URL::to('admin/categories/subcategories/'.$parentInfo->slug)}}" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                {{ Form::close()}}
               <div class="add_new_record"><a href="{{URL::to('admin/categories/addsub/'.$parentInfo->slug)}}" class="btn btn-default"><i class="fa fa-plus"></i> Add Sub Category</a></div>
            </div>            
            <div class="m_content" id="listID">
                @include('elements.admin.categories.indexsub')
            </div>
        </div>
    </section>
</div>
