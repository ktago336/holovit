...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('admin/localities/'.$cityData['slug'])}}"><i class="fa fa-globe"></i> <span>Manage Localities</span></a></li>
        ...
        <div class="box box-info">
            ...
            <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('locality_name', null, ['class'=>'form-control required alpha', 'placeholder'=>'Name', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    <div class="box-footer">
                        ...
                        <a href="{{ URL::to( 'admin/localities/add/'.$cityData['slug'])}}" title="Reset" class="btn btn-default canlcel_le">Reset</a>
                        @else
