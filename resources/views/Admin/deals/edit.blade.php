    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="ersu_message">@include('elements.admin.errorSuccessMessage')</div>
             {{Form::model($recordInfo, ['method' => 'post', 'id' => 'serviceForm', 'enctype' => "multipart/form-data"]) }}
...
//                            print_r($merchants);
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <table cellpadding="5" class="mngs">
                                <tr>
                                    <td>

                                        <input id="all" type="radio" name="status" value="1" class="required" <?php echo $check1; ?> onchange="get_product(this.value);"><label>Select All Products to add in deal</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input id="sendTo" type="radio" name="status" value="2" class="required" <?php echo $check2; ?> onchange="get_product(this.value);"><label>Select Products to add in deal</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                         ...
                         ?>
                                ...
                                <div class="showeditimage">{{HTML::image(DEAL_SMALL_DISPLAY_PATH.$image, SITE_TITLE,['style'=>"height: 100px; max-width: 100px;display:inline-block;"])}}</div>

                                <div class="ad_s ajshort"><a href="{{ URL::to('admin/deals/deleteimageedit/'.$recordInfo['slug'].'/'.$image)}}" title="Cancel" class="canlcel_le"  onclick="return confirm('Are you sure you want to delete?')">X</a>
                                </div>
                                @endforeach
                                @endif
                            </div>
