            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="{{URL::to('admin/cities/'.$stateData['slug'])}}" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                {{ Form::close()}}
                <div class="add_new_record"><a href="{{URL::to('admin/cities/add/'.$stateData['slug'])}}" class="btn btn-default"><i class="fa fa-plus"></i> Add City</a></div>
            </div>            
            <div class="m_content" id="listID">
                @include('elements.admin.cities.index')
            </div>
        </div>
    </section>
</div>
