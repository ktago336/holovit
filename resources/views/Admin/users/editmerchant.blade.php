          ...
          <div class="form-horizontal">
              <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('name', null, ['class'=>'form-control required validname', 'placeholder'=>'Name', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('zipcode', null, ['class'=>'form-control required', 'maxlength'=>10, 'placeholder'=>'Zip Code', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::select('state_id',$state, null, ['id'=>'state_id', 'class'=>'form-control required', 'placeholder'=>'Select State', 'autocomplete'=>'OFF'])}}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
							{{Form::textarea('about_us', null, ['class'=>'form-control required', 'placeholder'=>'About Us', 'autocomplete' => 'off', 'rows'=>4])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('busineess_name', null, ['class'=>'form-control required', 'placeholder'=>'Business Name', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('email_address', null, ['class'=>'form-control required email', 'placeholder'=>'Email Address', 'autocomplete' => 'off', 'readonly'=>'readonly'])}}
                        </div>
                    </div>
                 ...
                 <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="ImageID">
                                ...
                                <div class="ad_s ajshort"><a href="{{ URL::to('admin/admins/deleteimagemerchant/'.$recordInfo['slug'].'/'.$image)}}" title="Cancel" class="canlcel_le"  onclick="return confirm('Are you sure you want to delete?')">X</a>
                                </div>
                                </div>
                                @endforeach
                                @endif
