            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="{{URL::to('admin/states/'.$countryData['slug'])}}" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                {{ Form::close()}}
                <div class="add_new_record"><a href="{{URL::to('admin/states/add/'.$countryData['slug'])}}" class="btn btn-default"><i class="fa fa-plus"></i> Add State</a></div>
            </div>            
            <div class="m_content" id="listID">
                @include('elements.admin.states.index')
            </div>
        </div>
    </section>
</div>
