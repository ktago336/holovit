    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="admin_search">
                ...
                <div class="add_new_record"><a href="{{URL::to('admin/services/add')}}" class="btn btn-default"><i class="fa fa-plus"></i> Add Service</a></div>
            <?php } } else{?><div class="add_new_record"><a href="{{URL::to('admin/services/add')}}" class="btn btn-default"><i class="fa fa-plus"></i> Add Service</a></div>
            <?php } ?>
            </div>            
