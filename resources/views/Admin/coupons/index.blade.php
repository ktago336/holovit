            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="{{URL::to('admin/coupons')}}" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                {{ Form::close()}}
                 <?php $role = 2; if(isset($checkSubRols[5])){
                    if ($adminLId == 1 || in_array($role, $checkSubRols[5])) { ?>
                <div class="add_new_record"><a href="{{URL::to('admin/deals/add')}}" class="btn btn-default"><i class="fa fa-plus"></i> Add Deal</a></div>
            <?php } } else{?><!--<div class="add_new_record"><a href="{{URL::to('admin/deals/add')}}" class="btn btn-default"><i class="fa fa-plus"></i> Add Deal</a></div>-->
            <?php } ?>
            </div>            
            <div class="m_content" id="listID">
                @include('elements.admin.coupons.index')
            </div>
        </div>
    </section>
</div>
