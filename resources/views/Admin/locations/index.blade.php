        ...
        <div class="box box-info">
            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    <span class="hints">Search by Location Name</span>
                ...
                {{ Form::close()}}
               <div class="add_new_record"><a href="{{URL::to('admin/locations/add')}}" class="btn btn-default"><i class="fa fa-plus"></i> Add Location</a></div>
            </div>            
