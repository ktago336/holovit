...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('admin/business_types')}}"><i class="fa fa-legal"></i> <span>Manage Business Types</span></a></li>
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ URL::to( 'admin/business_types')}}" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
                    </div>
                </div>
            </div>
            {{ Form::close()}}
