...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('admin/deals')}}"><i class="fa fa-list"></i> <span> Product</span></a></li>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="ImageID">
                              ...
                              $videos = explode(',',$video);
                                ...
                                <div class="ad_s ajshort video_delete"><button disabled><?php echo $video; ?></button><a href="{{ URL::to('admin/deals/deletevideoedit/'.$recordInfo['slug'].'/'.$video)}}" title="Cancel" class="canlcel_le"  onclick="return confirm('Are you sure you want to delete?')"> X </a>
