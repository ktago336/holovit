        ...
        <div class="box box-info">
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Time to complete Deal <span class="require">*</span></label>
                        <div class="col-sm-10">
                            {{Form::text('minutes', null, ['class'=>'form-control required number', 'min'=>'0', 'placeholder'=>'Minutes', 'autocomplete' => 'off'])}}
                        </div>
                    </div>
                     <div class="form-group">
                        <label class="col-sm-2 control-label">Deal Image <span class="require"></span></label>
                        <div class="col-sm-10">
                            ...
                            <span class="help-text"> Supported File Types: jpg, jpeg, png (Max. {{ MAX_IMAGE_UPLOAD_SIZE_DISPLAY }}).</span>
                             @if($recordInfo->service_image != '')
                                ...
                                <div class="help-text"><a href="{{ URL::to('admin/deals/deleteimage/'.$recordInfo->slug)}}" title="Cancel" class="canlcel_le"  onclick="return confirm('Are you sure you want to delete?')">Delete Image</a></div>
                             @endif
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ URL::to( 'admin/deals')}}" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
                    </div>
                </div>
            </div>
            {{ Form::close()}}
