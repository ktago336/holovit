    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6" data-aos="fade-left">
                <div class="about-img">{{HTML::image('public/img/front/banner-img3.png', SITE_TITLE)}}</div>
            </div>
        </div>
    </div>
</section> -->
            ...
            <div class="row">
                <div class="col-sm-8 col-md-8">
                    <div class="blog-post">
                        <div class="thumbnail">
                            <div class="blog-img">
                                {{HTML::image('public/img/front/blog-img2.jpg', SITE_TITLE)}}
                            </div>
                            <div class="caption">
                    ...
                    <div class="blog-post">
                        <div class="thumbnail">
                            <div class="blog-img">
                                {{HTML::image('public/img/front/blog-img1.jpg', SITE_TITLE)}}
                            </div>
                            <div class="caption">
                    ...
                    <div class="blog-post">
                        <div class="thumbnail">
                            <div class="blog-img">
                                {{HTML::image('public/img/front/blog-img3.jpg', SITE_TITLE)}}
                            </div>
                            <div class="caption">
