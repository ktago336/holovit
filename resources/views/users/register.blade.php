                            ...
                            {{ Form::open(array('method' => 'post', 'id' => 'loginform', 'class' => 'form form-signin')) }}
                                ...
                                <div class="form-group"> 
                                    <div class="Groupon_clone">
                                        ...
                                        {{Form::text('email_address', Cookie::get('user_email_address'), ['class'=>'form-control required email', 'placeholder'=>'E-mail', 'autocomplete'=>'OFF'])}}
                                    </div>
                                </div>
                                <div class="form-group"> 
                                    <div class="Groupon_clone">
                                ...
                                <div class="form-group">
                                    <div class="Groupon_clone_button">
                                        ...
                                        <div class="sin-txt">Already have an account? <a href="{{ URL::to('login')}}">Sign In</a></div>
                                    </div>
                                </div>
                            {{ Form::close()}}
                        </div>
