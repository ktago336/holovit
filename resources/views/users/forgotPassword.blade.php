                ...
                <div class="container-user-login">
                    <div class="login-part">
                        ...
                        <div class="login-form">
                            {{ Form::open(array('url' => '/forgot-password', 'method' => 'post', 'id' => 'loginform', 'class' => 'form form-signin')) }}
                               ...
                               <div class="form-group">
                                    <div class="Groupon_clone_button">
                                        ...
                                        <div class="create-acc">Already Have an Account? <a href="{{url('/login')}}">Login</a></div>
                                    </div>
                                </div>
                            {{ Form::close()}}
                        </div>
