                ...
                <div class="container-login">
                    <div class="login-part">
                        ...
                        <div class="login-form">
                            {{ Form::open(array('url' => '/login', 'method' => 'post', 'id' => 'loginform', 'class' => 'form form-signin')) }}
                                <div class="form-group"> 
                                    <div class="Groupon_clone">
                                        <span><i class="fa fa-envelope-open-o" aria-hidden="true"></i></span>
                                        {{Form::text('username', Cookie::get('user_username'), ['class'=>'form-control required email', 'placeholder'=>'E-mail'])}}
                                    </div>
                                </div>
                                <div class="form-group"> 
                                    <div class="Groupon_clone">
                                ...
                                <div class="form-group"> 
                                    <div class="Groupon_clone_button">
                                        ...
                                        <div class="create-acc">Don't have an account? <a href="{{ URL::to('/register')}}">Create Account</a></div>
                                    </div>
                                </div>
                            {{ Form::close()}}
                        </div>
