                                                ...
                                                <div class="user-sec">
													...
													<div class="user-sec-in">
                                                        ...
                                                        <div class="user-sec-right">
                                                            ...
                                                            <img src="{{BARCODE_FULL_DISPLAY_PATH . $single_order->voucher_number.'.png'}}" alt="">
                                                            <?php }else{ ?>
                                                    ...
                                                    <div class="order-table-sec"  style="margin-left:-13px;">
                                                        ...
                                                        <div class="order-table-middel">
                                                            <div class="order-table-middel-in">
                                                                {{isset($deals[$dealid])?$deals[$dealid]:'Deleted'}}
                                                            </div>
															<!--<div class="order-table-middel-in">{{CURR.$dealsbparr[$key]}}</div>-->
															<div class="order-table-middel-in">{{isset($dealsfparr[$key])?CURR.$dealsfparr[$key]:''}}</div>
															<div class="order-table-middel-in">{{isset($dealsqtyparr[$key])?$dealsqtyparr[$key]:''}}</div>
                                                            <div class="order-table-middel-in">{{isset($dealsfparr[$key])?CURR.($dealsfparr[$key]*$dealsqtyparr[$key]):''}}</div>
                                                        </div>
                                                        <!--                                        <div class="order-table-middel">
                                                            <div class="order-table-middel-in">
