        ...
        <div class="container">
            ...
            <div class="row">
                @if(!$allrecords->isEmpty())
                    ...
                    <div class="col-sm-5 col-md-4 buycnt">
                        <div class="profile-bx">
                            <div class="profile-img">
                                @if($allrecord->Buyer->profile_image)
                            ...
                            <h2>{!! $allrecord->Buyer->first_name.' '.$allrecord->Buyer->last_name !!}</h2>
                            <p id="contactn" class="showall"> <span id="showcontact"> {!! $allrecord->Buyer->contact !!} </span> </p>
