                                ...
                                <div class="informetion_top">
                                   ...
                                   {{Form::model($recordInfo, ['method' => 'post', 'class' => 'form form-signin', 'id' => 'loginform','enctype' => "multipart/form-data"]) }}    
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            {{Form::text('first_name', null, ['id'=>'first_name', 'class'=>'form-control required validname', 'placeholder'=>'First Name', 'autocomplete'=>'OFF'])}}
                                        </div>
                                    </div>
									<div class="form-group">
                                        <label class="col-sm-3 control-label">Last Name<span class="require">*</span></label>
                                        <div class="col-sm-9">
                                            {{Form::text('last_name', null, ['id'=>'last_name', 'class'=>'form-control required validname', 'placeholder'=>'Last Name', 'autocomplete'=>'OFF'])}}
                                        </div>
                                    </div>
									<div class="form-group">
                                        <label class="col-sm-3 control-label">Email Address<span class="require">*</span></label>
                                        <div class="col-sm-9">
                                            {{Form::text('email_address', null, ['id'=>'email_address', 'class'=>'form-control required email', 'placeholder'=>'Email Address', 'autocomplete'=>'OFF', 'readonly'=>'readonly'])}}
                                        </div>
                                    </div>
									<div class="form-group">
                                   ...
                                   <div class="submit-input">
                                            ...
                                            <a href="{{ URL::to( 'users/myaccount')}}" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
                                        </div>
                                    {{ Form::close()}}
                                </div>
                            </div>
