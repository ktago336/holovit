                                    <div class="ersu_message">@include('elements.merchant.errorSuccessMessage')</div>
                                                ...
                                                <div class="fl-row fl-row--gutter">
                                                    <div class="fl-column">
                                                        <h2 class="card-main__heading">
                                                            ...
                                                            <span class="card-main__value m_locality line-height-xs display-inline-block font-weight-regular display-block margin-top-xs">location</span>
                                                    ...
                                                    <?php
                                                    $is_set_image = 0;
                                                    $image = explode(',', $merchants->images);
                                                    foreach ($image as $key => $images) {
                                                        ?>
                                                        <div class="fl-column">
                                                            {{HTML::image(DEAL_FULL_DISPLAY_PATH.$images, SITE_TITLE,['style'=>"max-width: 90px; max-height:54px;",'class'=>"card-main__img"])}}
                                                        </div>
                                                        <?php
                                                        $is_set_image = 1;
                                                        break;
                                                   ...
                                                   //     ->select("deals.*")
                                                    ...
                                                    <div class="card-list margin-top-s">
                                                        <div class="card-main">
                                                            ...
                                                            <span class="card-main__value txt-primary ellipsis line-height-primary font-weight-semibold ellipsis--sm"><?php echo $merchants->deal_name; ?></span>
                                                            <span class="card-main__value txt-primary line-height-primary font-weight-semibold"> from
                                                                <i class="fa fa-inr"></i> <?php echo $merchants->final_price; ?>
                                                            </span>
                                                    ...
                                                    <div class="card-list margin-top-s">
                                                        <div class="card-main">
                                                            ...
                                                            <span class="card-main__value txt-primary line-height-primary font-weight-semibold"> from
                                                                <i class="fa fa-inr"></i><?php echo $merchants->voucher_price; ?>
                                                            </span>
