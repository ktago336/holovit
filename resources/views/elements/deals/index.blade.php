...
<!--            <div class="td_tables">Deal Name</div>
            <div class="td_tables">Discount</div>
            <div class="td_tables">Expire Date</div>
            <div class="td_tables">Created On</div>-->
            ...
            <div data-title="Action" class="td_tables2">
                ...
                <div class="actions">
                    ...
                    <span class="right_acdc" id="status{{$allrecord->id}}">
                        ...
                        <a href="{{ URL::to( 'deals/deactivate/'.$allrecord->slug)}}" title="Deactivate" class="deactivate">
                            <button class="btn btn-primary btn-xs"><i class="fa fa-check"></i></button>
                        </a>
                        @else
                        <a href="{{ URL::to( 'deals/activate/'.$allrecord->slug)}}" title="Activate" class="activate"><button class="btn btn-primary btn-xs"><i class="fa fa-ban"></i></button></a>
                        @endif
                    </span>

                    <a href="{{ URL::to( 'deals/edit/'.$allrecord->slug)}}" title="Edit" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                    <a href="{{ URL::to( 'deals/delete/'.$allrecord->slug)}}" title="Delete" class="btn btn-primary btn-xs action-list delete-list" onclick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash-o"></i></a>
