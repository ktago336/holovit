<aside class="main-sidebar">
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="treeview @if(isset($actchangeusername) || isset($actchangepassword) || isset($actchangeemail) || isset($actsitesetting) || isset($actwhybuy)){{'active'}}@endif">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="@if(isset($actwhybuy)){{'active'}}@endif"><a href="{{HTTP_PATH}}/admin/admins/why-buy"><i class="fa fa-circle-o"></i> Why Buy Section</a></li>
...
<!--            <li class="treeview @if(isset($actservices)){{'active'}}@endif">
           ...
           <li class="treeview @if(isset($actlocations)){{'active'}}@endif">
			...
			<li class="treeview @if(isset($actwithdrawals)){{'active'}}@endif">
                <a href="{{HTTP_PATH}}/admin/wallets/withdrawals">
...
<!--            <li class="treeview @if(isset($acttestimonials)){{'active'}}@endif">
			...
			<li class="treeview @if(isset($actbanners)){{'active'}}@endif">
                <a href="{{HTTP_PATH}}/admin/banners">
