        ...
        <div class="st_pages_cnt">
            ...
            <div class="stp_right">
                ...
                <div class="form-group">
                    {{Form::text('name', null, ['class'=>'form-control required validname', 'placeholder'=>'Your name', 'autocomplete'=>'OFF'])}}
                </div>
                <div class="form-group">
                    {{Form::text('email', null, ['class'=>'form-control required email', 'placeholder'=>'Your email address', 'autocomplete'=>'OFF'])}}
                </div>
                <div class="form-group">
