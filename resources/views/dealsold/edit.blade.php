                            ...
                            <div class="add_deal">
                                <div class="informetion_top">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <div class="rdo-sprt-type0">
                                                <?php $product_ids = explode(',', $recordInfo->product_id); ?>
                                                {{Form::select('product_id[]', $product_name,$product_ids, ['class'=>'form-control','style' => $class,'id'=>'product_ids','multiple'=>'multiple', 'placeholder'=>'Select Product'])}}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <div class="ImageID">
                                                ...
                                                <div class="ad_s ajshort"><a href="{{ URL::to('deals/deleteimageedit/'.$recordInfo['slug'].'/'.$image)}}" title="Cancel" class="canlcel_le"  onclick="return confirm('Are you sure you want to delete?')">X</a>
                                                </div>
                                                </div>
                                                @endforeach
                                                @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {{Form::text('expire_date', null, ['class'=>'form-control expire_date required', 'readonly' => 'readonly', 'placeholder'=>'Expiry Date', 'autocomplete' => 'off','id'=>'expire_date'])}}
                                        </div>
                                    </div>
                                    <div class="form-group">
