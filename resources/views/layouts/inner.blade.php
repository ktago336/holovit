...
<!--        <title>{{$title.TITLE_FOR_LAYOUT}}</title>-->
   ...
   {{ HTML::style('public/css/front/owl.theme.default.min.css')}}
        ...
        {{ HTML::script('public/js/front/jquery-2.1.0.min.js')}}
        <!--{{ HTML::script('public/js/front/jquery.min.js')}}-->
		{{ HTML::script('public/js/jquery.cookie.js')}}
        {{ HTML::script('public/js/jquery.validate.js')}} 
         {{ HTML::script('public/js/front/popper.min.js')}}
        ...
        {{ HTML::script('public/js/front/ajaxsoringpagging.js')}}
{{ HTML::script('public/js/front/listing.js')}}
    </head>
    <body>
