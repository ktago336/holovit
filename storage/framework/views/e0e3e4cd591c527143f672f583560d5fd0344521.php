...
<script type="text/javascript">
 ...
 <section class="payment">
           <div class="container">
               <div class="row">
                   <div class="col-md-4">
				    <?php echo e(Form::open(array('url'=>'deals/generateorder/'.$recordInfo->slug.'/'.$offerinfo,'method' => 'post', 'id' => 'submitorder'))); ?>
        ...
        <div class="venue">
            <div class="margin-bottom-m">
                ...
                <div class="col-sm-4 col-md-4">
					...
					<?php $imgcnt = $imgcnt+1; ?>
						<?php echo e(HTML::image(MERCHANT_SMALL_DISPLAY_PATH.$image, SITE_TITLE,['style'=>"",'class'=>"img-responsive",'alt'=>"",'width'=>"55px",'data-lzled'=>"true"])); ?>
                ...
                <div class="col-sm-8 col-md-8">
                    ...
                    <!----><p class="font-weight-semibold line-height-xs margin-bottom-xs txt-primary"><?php echo e($recordInfo->busineess_name); ?></p>
                    <!----><p class="font-weight-semibold line-height-xs margin-bottom-xs txt-primary"><?php echo e($recordInfo->address.', '.$recordInfo->City->name); ?></p>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="venue__tickets">
				...
				<?php if(array_key_exists($dealinfo->id, $orders)): ?>
				<?php $subtotal = $subtotal+ $dealinfo->final_price*$orders[$dealinfo->id];?>	
				<div>
                    <hr class="thick-border--width-sm">
                    <p class="line-height-xs margin-bottom-xs"><?php echo e($dealinfo->deal_name); ?></p>
                    <div class="row">
                    <div class="col-sm-5 col-md-5">
                        <p>Qty. <?php echo e($orders[$dealinfo->id]); ?></p>
                    </div>
                    <div class="col-sm-7 col-md-7">
                       ...
                       <i class="nb-icon nb-icon_rupee nb-icon--xs"></i><?php echo e(CURR.$dealinfo->voucher_price*$orders[$dealinfo->id]); ?></span>
                            <!---->
                             <?php echo e((CURR.$dealinfo->final_price*$orders[$dealinfo->id])); ?></p>
                        </div>
                    </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6">
                <p class="txt-tertiary">Subtotal
                    <b> (Qty. <?php echo e(array_sum($orders)); ?>)</b>
                </p>
            </div>
            <div class="col-sm-6 col-md-6">
                <div class="txt-right">
                    <p class="txt-primary font-xxl font-weight-semibold">  <?php echo e(CURR.$subtotal); ?></p>
                </div>
            </div>
        </div>
		<div class="row">
            ...
            <div class="col-sm-6 col-md-6">
                <div class="txt-right">
                    <p class="txt-primary font-xxl font-weight-semibold">  <?php echo e(CURR.$recordInfo->convenience_fees); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-8 col-md-8">
                <div class="txt-right">
                    ...
                    <?php echo e(CURR.($subtotal+$recordInfo->convenience_fees)); ?>
					...
					<input type="hidden" name="convenience_fees" value="<?php echo e($recordInfo->convenience_fees); ?>" />
					<input type="hidden" name="total_price" value="<?php echo e(($subtotal+$recordInfo->convenience_fees)); ?>" />
...
<div class="form-group">
     <label class="margin-bottom-s">Wallet Balance : <?php echo e(CURR.$userInfo->wallet_balance); ?></label>
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lscouponslogicsp/public_html/resources/views/deals/ordersummary.blade.php ENDPATH**/ ?>