        ...
        <div class="box box-info">
            ...
            <div class="form-horizontal">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo e(URL::to( 'admin/states/add/'.$countryData['slug'])); ?>" title="Reset" class="btn btn-default canlcel_le">Reset</a>
                        <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/admin/states/add.blade.php ENDPATH**/ ?>