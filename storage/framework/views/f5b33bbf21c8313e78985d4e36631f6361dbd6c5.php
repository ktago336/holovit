...
<div class="hp">
    ...
    <div class="topn_rightd ddpagingshorting" id="pagingLinks" align="right">
		...
		<div class="table_responsive">
                <div class="table_dcf">
                    <div class="tr_tables">
						<div class="td_tables"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('Order.order_number', 'Order ID'));?></div>
						<div class="td_tables"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('User.first_name', 'Customer Name'));?></div>
                    ...
                    <div class="tr_tables2">
                                            <div data-title="Order ID" class="td_tables2">
                                               <?php echo "#".$merchants->Order->order_number; ?> 
                                            </div>
											<div data-title="Customer Name" class="td_tables2">
                                               <?php echo $merchants->User->first_name.' '. $merchants->User->last_name; ?>
                                            </div>
...
<?php endif; ?><?php /**PATH /home/lscouponslogicsp/public_html/resources/views/elements/merchant/users/mywallet.blade.php ENDPATH**/ ?>