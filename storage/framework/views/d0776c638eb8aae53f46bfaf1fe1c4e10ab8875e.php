            ...
            <table class="table table-bordered table-striped table-condensed cf">
                <thead class="cf ddpagingshorting">
                    <tr>
                        ...
                        <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('order_id', 'Payment For'));?></th>
						...
						<th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('transaction_id', 'Transaction ID'));?></th>
                        <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('amount', 'Total Paid Amount'));?></th>
                        <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('payment_mode', 'Payment Via'));?></th>
                        <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('created_at', 'Payment Date'));?></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-title="Payment For"><?php echo e(($allrecord->order_id > 0)?"Purchase Deal":"Upgrade Wallet"); ?></td>
						<td data-title="Customer Name"><?php echo e($allrecord->User->first_name.' '.$allrecord->User->last_name); ?></td>
                        <td data-title="Order Number"><?php echo e($allrecord->order_number?'#'.$allrecord->order_number:"N/A"); ?></td>
                        <td data-title="Transaction ID"><?php echo e('#'.$allrecord->transaction_id); ?></td>
                        <td data-title="Total Paid Amount"><?php echo e(CURR); ?><?php echo e($allrecord->amount); ?></td>
                        <td data-title="Payment Via"><?php echo e($allrecord->payment_mode?$allrecord->payment_mode:"Paypal"); ?></td>
...
@endforeach<?php */ ?>
<?php endif; ?><?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/elements/admin/payments/index.blade.php ENDPATH**/ ?>