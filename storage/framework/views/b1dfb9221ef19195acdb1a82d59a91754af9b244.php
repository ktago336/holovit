            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo e(URL::to( 'admin/categories/subcategories/'.$parentInfo->slug)); ?>" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/admin/categories/editsub.blade.php ENDPATH**/ ?>