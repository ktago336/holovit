...
<?php //echo '<pre>'; print_r($merchant); exit; ?>
                                                <div class="fl-row fl-row--gutter">
                                                    ...
                                                    foreach ($image as $key => $images) {
                                                        ?>
                                                        <div class="fl-column">
                                                           <?php echo e(HTML::image(MERCHANT_SMALL_DISPLAY_PATH.$images, SITE_TITLE,['style'=>"max-width: 90px; max-height:54px;",'class'=>"card-main__img"])); ?>
                                               ...
                                               // if (!empty($deal)){
                                                    ...
                                                    <div class="card-list margin-top-s">
														...
														<?php if(!empty( $merchant->currentDeal)){ ?>
                                                            ...
                                                            <span class="card-main__value txt-primary ellipsis line-height-primary font-weight-semibold ellipsis--sm"><?php echo e($merchant->currentDeal->deal_name); ?></span>
                                                            <span class="card-main__value txt-primary line-height-primary font-weight-semibold"> from
                                                                <?php echo e(CURR.$merchant->currentDeal->final_price); ?>
                              ...
                              <?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/elements/deals/individual_product.blade.php ENDPATH**/ ?>