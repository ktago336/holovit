                ...
                <div class="container-user-login">
                    <div class="login-part">
                        ...
                        <div class="login-form"> 
                            <?php echo e(Form::open(array('route' => 'merchant.login.save', 'method' => 'post', 'id' => 'loginform', 'class' => 'form form-signin'))); ?>

                                <div class="form-group"> 
                                    <div class="Groupon_clone">
                                       <i class="fa fa-envelope-open-o" aria-hidden="true"></i>
                                        <?php echo e(Form::text('username', Cookie::get('user_username'), ['class'=>'form-control required', 'placeholder'=>'E-mail'])); ?>
                                ...
                                <div class="form-group"> 
                                    <div class="Groupon_clone">
                                        ...
                                        <div class="forgot">
                                            <a href="<?php echo e(URL::to('/merchant/forgot-password')); ?>">Forgot Password?</a>
                                        </div>
                                ...
                                <div class="form-group"> 
                                    <div class="Groupon_clone_button">
                                        ...
                                        <div class="create-acc">Don't have an account? <a href="<?php echo e(URL('/merchant/register')); ?>">Sign Up</a></div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.merchant_inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/merchant/user/login.blade.php ENDPATH**/ ?>