                            ...
                            <div class="add_deal add_deal_my">
                                <div class="informetion_top">
                                    <div class="tatils_0t1"> My Profile<div class="add-list">
                                      <a href="<?php echo e(URL::to( 'users/editprofile')); ?>"><i class="fa fa-edit"></i>Edit Profile</a>
                                   ...
                                   <?php echo e(Form::model($recordInfo, ['method' => 'post', 'class' => 'form form-signin', 'id' => 'loginform','enctype' => "multipart/form-data"])); ?>    
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="my-ad">
                                            <?php echo e($recordInfo->last_name); ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="my-ad">
                                            <?php echo e($recordInfo->email_address); ?>
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lscouponslogicsp/public_html/resources/views/users/myaccount.blade.php ENDPATH**/ ?>