        ...
        <div class="box box-info">
            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    <span class="hints">Search by Customer Name or Email Address</span>
                ...
                <div class="add_new_record"><a href="<?php echo e(URL::to('admin/users/add')); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Add Customer</a></div>
                 <?php } }else{?>
                    <div class="add_new_record"><a href="<?php echo e(URL::to('admin/users/add')); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Add Customer</a></div>
                 <?php } ?>
            </div>            
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/admin/users/index.blade.php ENDPATH**/ ?>