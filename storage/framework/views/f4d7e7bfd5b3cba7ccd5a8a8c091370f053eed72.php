        ...
        <div class="st_pages_cnt">
            ...
            <div class="stp_right">
                ...
                <div class="form-group">
                    <?php echo e(Form::text('name', null, ['class'=>'form-control required validname', 'placeholder'=>'Your name', 'autocomplete'=>'OFF'])); ?>

                </div>
                <div class="form-group">
                    <?php echo e(Form::text('email', null, ['class'=>'form-control required email', 'placeholder'=>'Your email address', 'autocomplete'=>'OFF'])); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/pages/contactus.blade.php ENDPATH**/ ?>