<table width="710" align="center" style="table-layout:fixed; font-family:Arial, Helvetica, sans-serif; border:1px solid #537286; box-shadow: 0 0 5px #537286; padding:10px 15px;">
    <tbody><tr>
            <td valign="top" style=" background-color: #ffffff; border-bottom: 1px #dddddd solid;">
                <table width="100%">
                    <tbody><tr>
                            <td>
        ...
        <tr>
            <td valign="top">
                <!-- Begin Footer -->
                <table width="100%" style="border-top:1px solid #dddddd; background-color:#ffffff; color: #0B0B0B;">
                    <tbody><tr>
                            <td style="font-size:12px;">
                                <p style="color:#333333; width:100%;">&nbsp;Copyright &copy; <?php echo date('Y'); ?> <?php echo SITE_TITLE; ?> All Rights Reserved.</p>
...
</table><?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/emails/emailtemplate.blade.php ENDPATH**/ ?>