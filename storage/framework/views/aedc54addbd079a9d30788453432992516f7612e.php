    ...
    <div class="panel-body marginzero">
        ...
        <?php echo e(Form::open(array('method' => 'post', 'id' => 'actionFrom'))); ?>
            ...
            <section id="no-more-tables" class="lstng-section">
                <div class="topn">
                    <div class="topn_left">Cities List</div>
                ...
                <table class="table table-bordered table-striped table-condensed cf">
                    <thead class="cf ddpagingshorting">
                        <tr>
                            <th style="width:5%">#</th>
                            <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('name', 'City Name'));?></th>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $allrecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td data-title="City Name"><?php echo e($allrecord->name); ?></td>
                                ...
                                <td data-title="Action">
                                   ...
                                   <span class="right_acdc" id="status<?php echo e($allrecord->id); ?>">
                                        <?php if($allrecord->status == '1'): ?>
                                            <a href="<?php echo e(URL::to( 'admin/cities/deactivate/'.$allrecord->slug)); ?>" title="Deactivate" class="deactivate"><button class="btn btn-success btn-xs"><i class="fa fa-check"></i></button></a>
                                        <?php else: ?>
                                            <a href="<?php echo e(URL::to( 'admin/cities/activate/'.$allrecord->slug)); ?>" title="Activate" class="activate"><button class="btn btn-danger btn-xs"><i class="fa fa-ban"></i></button></a>
                                        <?php endif; ?>
                                    </span>
                               <a href="<?php echo e(URL::to( 'admin/cities/edit/'.$allrecord->slug)); ?>" title="Edit" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                               <a href="<?php echo e(URL::to( 'admin/cities/delete/'.$allrecord->slug)); ?>" title="Delete" class="btn btn-danger btn-xs action-list delete-list" onclick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash-o"></i></a>
                               <a href="<?php echo e(URL::to( 'admin/localities/'.$allrecord->slug)); ?>" title="Locality List" class="btn btn-warning btn-xs" ><i class="fa fa-plus"></i></a>
                                </td>
                            </tr>
...
<?php endif; ?>
<?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/elements/admin/cities/index.blade.php ENDPATH**/ ?>