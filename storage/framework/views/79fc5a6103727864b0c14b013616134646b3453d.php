                    ...
                    <div class="panel-body">
                        <div class="tab-pane" id="2">
                            <div class="add_deal">
								...
								<?php echo e(Form::model($recordInfo,array('method' => 'post', 'id' => 'serviceForm', 'enctype' => "multipart/form-data"))); ?>

                                    
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Deal Name <span class="require">*</span></label>
                                        <div class="col-sm-10">
                                            <?php echo e(Form::text('deal_name', null, ['class'=>'form-control required', 'placeholder'=>'Deal Name', 'autocomplete' => 'off'])); ?>
								...
								<?php endif; ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo e(Form::select('voucher_type',$vouchers, null, ['class'=>'form-control required', 'placeholder'=>'Voucher Type', 'autocomplete' => 'off'])); ?>

                                        </div>
                                    </div>
									<div class="form-group">
                                        <label class="col-sm-2 control-label">Voucher Price(<?php echo e(CURR); ?>)<span class="require">*</span></label>
                                        <div class="col-sm-10">
                                            <?php echo e(Form::text('voucher_price', null, ['class'=>'form-control required number', 'placeholder'=>'Voucher Price('.CURR.')', 'autocomplete' => 'off', 'min' => '0', 'max' => '999999'])); ?>
									...
									<!--<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo e(Form::text('contact', null, ['class'=>'form-control required number', 'placeholder'=>'Phone Number', 'autocomplete' => 'off'])); ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo e(Form::select('popular_time',$popular_time, null, ['class'=>'form-control required ', 'placeholder'=>'Most popular time of the day', 'autocomplete' => 'off'])); ?>
									...
									<div class="form-group">
										...
										<?php $amenitie_id_arr = explode(',',$recordInfo->amenitie_id);?>
                                            ...
                                            <?php echo e(Form::select('amenitie_id[]',$amenitie, $amenitie_id_arr, ['class'=>'form-control ','multiple'=>'multiple', 'autocomplete' => 'off'])); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo e(Form::text('valid_for', null, ['class'=>'form-control required digits', 'placeholder'=>'Valid For(Per Person)', 'autocomplete' => 'off', 'min' => '1', 'max' => '100'])); ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo e(Form::select('deal_start_time',$time_array, null, ['class'=>'form-control required ', 'placeholder'=>'Start Time', 'autocomplete' => 'off'])); ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo e(Form::select('deal_end_time',$time_array, null, ['class'=>'form-control required ', 'placeholder'=>'End Time', 'autocomplete' => 'off'])); ?>
                                   ...
                                   <!-- <div class="form-group">
                                        ...
                                        <div class="col-sm-10">-->
                                           ...
                                           <!--  <div class="rdo-sprt">
                                            ...
                                            <div class="rdo-sprt-type0">
                                                <?php echo e(Form::select('product_id[]', $product_name,null, ['class'=>'form-control','style' => $class,'id'=>'product_ids','multiple'=>'multiple', 'placeholder'=>'Select Product'])); ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo e(Form::text('discount', null, ['class'=>'form-control required number', 'min'=>'1','max'=>'99', 'placeholder'=>'Discount', 'id'=>'discount', 'autocomplete' => 'off','onkeyup' => 'getprice()'])); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo e(Form::textarea('description', null, ['class'=>'form-control', 'placeholder'=>'Enter Description', 'autocomplete' => 'off', 'rows'=>4])); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo e(Form::file('images[]', ['class'=>'form-control', 'accept'=>IMAGE_EXT,'multiple'=>true,'id' => 'add_images'])); ?>
                                            ...
                                            <div class="ImageID">
                                                ...
                                                <div class="show-ad">
                                                <div class="showeditimage"><?php echo e(HTML::image(DEAL_FULL_DISPLAY_PATH.$image, SITE_TITLE,['style'=>"height: 100px; max-width: 100px;display:inline-block;"])); ?></div>

                                                <div class="ad_s ajshort"><a href="<?php echo e(URL::to('merchant/deals/deleteimageedit/'.$recordInfo['slug'].'/'.$image)); ?>" title="Cancel" class="canlcel_le"  onclick="return confirm('Are you sure you want to delete?')">X</a>
                                                </div>
                                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo e(Form::text('expire_date', null, ['class'=>'form-control expire_date required', 'placeholder'=>'Expiry Date', 'readonly' => 'readonly', 'autocomplete' => 'off','id'=>'expire_date'])); ?>
...
<?php echo $__env->make('layouts.merchant_inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lscouponslogicsp/public_html/resources/views/merchant/deals/edit.blade.php ENDPATH**/ ?>