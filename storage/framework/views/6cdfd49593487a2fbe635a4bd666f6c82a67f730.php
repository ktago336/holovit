...
<section class="listing_deal margin_top">
  <div class="container">
                                                ...
                                                <div class="user-sec">
													...
													<div class="user-sec-in">
                                                        ...
                                                        <div class="user-sec-right">
                                                            <?php if(file_exists(BARCODE_FULL_UPLOAD_PATH . $single_order->voucher_number.'.png')){?>
                                                            <img src="<?php echo e(BARCODE_FULL_DISPLAY_PATH . $single_order->voucher_number.'.png'); ?>" alt="">
                                                            <?php }else{ ?>
                                                            <?php echo $single_order->voucher_number; ?>
                                                            <?php } ?>
                                                        </div>
                                                    </div>
                                                    <div class="user-sec-in">
											...
											<div class="form-group">
                                                <div class="user-sec">
                                                    ...
                                                    <div class="user-sec-in">
                                                        ...
                                                        <div class="user-sec-right"><?php echo isset($single_order->Payment->transaction_id)?$single_order->Payment->transaction_id:'N/A'; ?></div>
                                                    </div>
													<div class="user-sec-in">
                                                        <div class="user-sec-left">Payment Method</div>
                                                        <div class="user-sec-right"><?php echo (isset($single_order->Payment->payment_mode) && $single_order->Payment->payment_mode!='')?$single_order->Payment->payment_mode:'Paypal'; ?></div>
                                                    </div>
                                                    <div class="user-sec-in">
                                                        <div class="user-sec-left">Payment Status</div>
                                                        <div class="user-sec-right">
                                                            <?php echo isset($single_order->Payment->status)?"Paid":"Pending"; ?>
                                                        </div>
                                                    </div>
                                                    <div class="user-sec-in">
                                                        <div class="user-sec-left">Payment Date/Time</div>
                                                        <div class="user-sec-right"><?php echo isset($single_order->Payment->created_at)?$single_order->Payment->created_at:'N/A'; ?></div>
                                                    </div>
                                                    ...
                                                    <div class="order-table-sec"  style="margin-left:-13px;">
                                                        ...
                                                        <div class="order-table-middel">
                                                            <div class="order-table-middel-in">
                                                                <?php echo e(isset($deals[$dealid])?$deals[$dealid]:'Deleted'); ?>

                                                            </div>
															<!--<div class="order-table-middel-in"><?php echo e(CURR.$dealsbparr[$key]); ?></div>-->
															<div class="order-table-middel-in"><?php echo e(isset($dealsfparr[$key])?CURR.$dealsfparr[$key]:''); ?></div>
															<div class="order-table-middel-in"><?php echo e(isset($dealsqtyparr[$key])?$dealsqtyparr[$key]:''); ?></div>
                                                            <div class="order-table-middel-in"><?php echo e(isset($dealsfparr[$key])?CURR.($dealsfparr[$key]*$dealsqtyparr[$key]):''); ?></div>
                                                        </div>
                                                        <!--                                        <div class="order-table-middel">
                                                            <div class="order-table-middel-in">
                                            ...
                                            <div class="form-group">
                                                <div class="order-sec user-sec">
                                                    ...
                                                    <div class="order-table-sec">
                                                        ...
                                                        foreach ($single_order->Orderitems as $deal) {
                                                        ?>
                                                        <div class="order-table-middel">
                                                            <div class="order-table-middel-in">
                                                                <div class="menucmtilet">
                                                                    <?php echo $deal->product_title; ?>
                                                                </div>
                                                                <div class="menucmt">
                                                                    <?php
                                                                    if (!empty($deal->image)) {
                                                                    ...
                                                                    echo $this->Html->image(DISPLAY_THUMB_PRODUCT_IMAGE_PATH . $image, array('alt' => '', 'class' => 'image', 'url' => ['controller' => 'products', 'action' => 'details', $deal->slug]));
                                                                    }
                                                                    ?>
                                                                    <?php ?>
                                                                    <?php
                                                                    } else {
                                                                    echo $this->Html->image('no_image1.png', array('alt' => '', 'url' => ['controller' => 'products', 'action' => 'details', $deal->slug]));
                                                                    }
                                                                    ?>
                                                                </div>
                                                            </div>
                                                            <div class="order-table-middel-in"><?php echo CURR . $deal->price; ?></div>
                                                            <div class="order-table-middel-in"><?php echo $deal->quantity; ?></div>
                                                            <div class="order-table-middel-in"><?php echo CURR . $deal->subtotal; ?></div>
                                                        </div>
                                                        <!--                                        <div class="order-table-middel">
                                                            <div class="order-table-middel-in">
                                                                <div class="menucmtilet">
...
*/?>
                                    ...
                                    <?php /*<div class="form-group" id="print_sec">
                                        <div class="user-sec">
                                            <div class="user-sec-in">
                                                <form>
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lscouponslogicsp/public_html/resources/views/users/orderDetail.blade.php ENDPATH**/ ?>