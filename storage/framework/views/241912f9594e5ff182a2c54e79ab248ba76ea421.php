                                ...
                                <div class="informetion_top">
                                   ...
                                   <?php echo e(Form::model($recordInfo, ['method' => 'post', 'class' => 'form form-signin', 'id' => 'loginform','enctype' => "multipart/form-data"])); ?>    
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                           <?php echo e(Form::text('busineess_name', null, ['id'=>'busineess_name', 'class'=>'form-control required validname', 'placeholder'=>'Business Name', 'autocomplete'=>'OFF'])); ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                           <?php echo e(Form::text('address', null, ['id'=>'address', 'class'=>'form-control required', 'placeholder'=>'Address', 'autocomplete'=>'OFF'])); ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                           <?php echo e(Form::text('zipcode', null, ['id'=>'zipcode', 'class'=>'form-control required', 'maxlength'=>10, 'placeholder'=>'Zipcode', 'autocomplete'=>'OFF'])); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                           <?php echo e(Form::text('contact', null, ['id'=>'contact', 'class'=>'form-control required digits', 'placeholder'=>'Contact Number', 'autocomplete'=>'OFF', 'minlength' => 8, 'maxlength' => 16])); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
											<?php echo e(Form::select('business_type',$business_category, null, ['id'=>'business_type', 'class'=>'form-control', 'placeholder'=>'Select Business Category', 'autocomplete'=>'OFF', 'disabled'=>'disabled'])); ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
											<?php echo e(Form::textarea('about_us', null, ['class'=>'form-control ', 'placeholder'=>'About Us', 'autocomplete' => 'off', 'rows'=>4])); ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <?php echo e(Form::text('name', null, ['id'=>'name', 'class'=>'form-control required validname', 'placeholder'=>'Name', 'autocomplete'=>'OFF'])); ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <?php echo e(Form::text('email_address', null, ['id'=>'email_address', 'class'=>'form-control required', 'placeholder'=>'Email Address', 'autocomplete'=>'OFF'])); ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="ImageID">
                                                ...
                                                <div class="ad_s ajshort"><a href="<?php echo e(URL::to('merchant/user/deleteprofileimageedit/'.$recordInfo['slug'].'/'.$image)); ?>" title="Cancel" class="canlcel_le"  onclick="return confirm('Are you sure you want to delete?')">X</a>
                                                </div>
                                                </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                        ...
                                        <div class="form-group">
											...
											<div class="col-sm-9">
                                            <?php echo e(Form::password('old_password', ['class'=>'form-control ', 'placeholder' => 'Password', 'minlength' => 8])); ?>
                                   ...
                                   <div class="submit-input">
                                            ...
                                            <a href="<?php echo e(URL::to( 'merchant/user/myaccount')); ?>" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
...
<?php echo $__env->make('layouts.merchant_inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/merchant/user/editprofile.blade.php ENDPATH**/ ?>