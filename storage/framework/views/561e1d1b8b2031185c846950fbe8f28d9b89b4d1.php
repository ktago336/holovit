            ...
            <section id="no-more-tables" class="lstng-section">
                ...
                <table class="table table-bordered table-striped table-condensed cf">
                    <thead class="cf ddpagingshorting">
                        <tr>
                            <th style="width:5%">#</th>
							<th class="sorting_paging">Banner</th>
                            <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('title', 'Title'));?></th>
                            <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('banner_url', 'Banner Link'));?></th>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $allrecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td data-title="Banner Name">
								<?php if($allrecord->banner_image != ''): ?>
                        <label><?php echo e(HTML::image(BANNER_SMALL_DISPLAY_PATH.$allrecord->banner_image, SITE_TITLE,['style'=>"max-width: 50px"])); ?></label>
                        <?php else: ?>
                        ...
                        <?php endif; ?></td>
                                ...
                                <td data-title="Banner Link"><?php echo e($allrecord->banner_url); ?></td>
                                ...
                                <td data-title="Action">
                                   ...
                                   <span class="right_acdc" id="status<?php echo e($allrecord->id); ?>">
                                        <?php if($allrecord->status == '1'): ?>
                                            <a href="<?php echo e(URL::to( 'admin/banners/deactivate/'.$allrecord->slug)); ?>" title="Deactivate" class="deactivate"><button class="btn btn-success btn-xs"><i class="fa fa-check"></i></button></a>
                                        <?php else: ?>
                                            <a href="<?php echo e(URL::to( 'admin/banners/activate/'.$allrecord->slug)); ?>" title="Activate" class="activate"><button class="btn btn-danger btn-xs"><i class="fa fa-ban"></i></button></a>
                                        <?php endif; ?>
                                    </span>
...
<?php endif; ?>
<?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/elements/admin/banners/index.blade.php ENDPATH**/ ?>