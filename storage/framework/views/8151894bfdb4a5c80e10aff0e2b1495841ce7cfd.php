                    ...
                    <tbody>
                        <?php $__currentLoopData = $allrecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td data-title="Country Name"><?php echo e($allrecord->name); ?></td>
                               ...
                               <a href="<?php echo e(URL::to( 'admin/states/'.$allrecord->slug)); ?>" title="State List" class="btn btn-warning btn-xs" ><i class="fa fa-plus"></i></a>
                                </td>
                            </tr>
...
<?php endif; ?>
<?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/elements/admin/countries/index.blade.php ENDPATH**/ ?>