...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Orders Details (Order Number: #<?php echo e($single_order->order_number); ?>)</h1>
        <ol class="breadcrumb">
											...
											<div class="form-group">
                                                <div class="user-sec">
                                                    ...
                                                    <div class="user-sec-in">
                                                        ...
                                                        <div class="user-sec-right"><?php echo isset($single_order->Payment->transaction_id)?$single_order->Payment->transaction_id:''; ?></div>
                                                    </div>
													<div class="user-sec-in">
                                                        <div class="user-sec-left">Payment Method</div>
                                                        <div class="user-sec-right"><?php echo isset($single_order->Payment->payment_mode)?$single_order->Payment->payment_mode:'Paypal'; ?></div>
                                                    </div>
                                                    <div class="user-sec-in">
                                                    ...
                                                    <div class="user-sec-in">
                                                        ...
                                                        <div class="user-sec-right"><?php echo isset($single_order->Payment->created_at)?$single_order->Payment->created_at:''; ?></div>
                                                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/admin/orders/details.blade.php ENDPATH**/ ?>