        ...
        <div class="header__primary">
            <div class="wrapper">
                <div class="container">
					...
					<?php echo e(Form::open(array('url'=>'deals/setlocation','method' => 'post', 'id' => 'setlocation'))); ?>
                            ...
                            <div class="texticon-group">
                                ...
                                <div class="select-location">
                                    <span>
                                        <?php echo e(Form::select('city_id', $cities,null, ['placeholder'=>'Select Location', 'class'=>'form-control', 'id'=>'city_id'])); ?>
...
<?php echo e(Form::open(array('url'=>'deals/search','method' => 'post', 'id' => 'searchForm','onsubmit' => "return searchform()"))); ?>


<div class="input-group">
<?php echo e(Form::text('keyword', isset($search_keyword)?$search_keyword:null, ['class'=>'form-control', 'placeholder'=>'Search restaurants, spa, events', 'autocomplete' => 'off'])); ?>
...
<?php echo e(Form::submit('Search', ['class' => 'input-group-text','id'=>'basic-addon2'])); ?>
                        ...
                        <div class="right_p0">
                            <ul class="list_inline secondary_links flt-right">
                                <li class="show-on-tab">
                                    <a href="<?php echo e(URL::to('/how-it-works')); ?>" class="utility-btn">How it Works</a>
                                </li>
                                
                                <?php if(session()->has('user_id')): ?>
                                 <li class="show-on-tab"><a href="<?php echo e(URL::to('users/dashboard')); ?>">My Account</a></li>
                                     <?php else: ?>
                                <li class="show-on-tab">
                                    <a class="utility-btn" href="<?php echo e(URL::to('/merchant/register')); ?>">List your Business</a>
                                </li>
                                <li class="show-on-tab"> <a href="<?php echo e(URL::to('login')); ?>">Login</a></li>
                                 <li class="show-on-tab"><a href="<?php echo e(URL::to('register')); ?>">Sign Up</a></li>
                                 <?php endif; ?>
...
My Stuff <i class="fa fa-caret-down"></i> </a>
    <div class="my-stuff dropdown-menu dropdown-list dropdown-menu-right dropdown">
     <ul>
		<li> <i class="fa fa-user"></i> <a href="<?php echo e(URL('/users/myaccount')); ?>">My Profile</a></li> 
        <li> <i class="fa fa-shopping-bag"></i> <a href="<?php echo e(URL('/users/myorders')); ?>">My Orders</a></li>
		<li> <i class="fa fa-google-wallet"></i> <a href="<?php echo e(URL('/users/mywallet')); ?>">My Wallet</a></li> 
		<li> <i class="fa fa-history"></i> <a href="<?php echo e(URL('/users/mypayments')); ?>">Payment History</a></li> 
        <li> <i class="fa fa-sign-out"></i> <a href="<?php echo e(URL('/logout')); ?>">Logout</a></li> 
     </ul>
...
<a class="nav-link" href="<?php echo HTTP_PATH.'/deals/search';?>"><i><?php echo e(HTML::image('public/img/front/food-icon.png','icon')); ?></i>All</a>
</li>-->
<?php $categories = DB::table('categories')->where(['parent_id' => 0, 'status' => 1, 'is_feature' => 1])->orderBy('category_name', 'ASC')->take(8)->get(); ?>
<?php if($categories): ?>
<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<li class="nav-item <?php echo (isset($slug) && $slug==$allrecord->slug)?'active':''?>">
<a class="nav-link" href="<?php echo e(URL::to('deals/search/'.$allrecord->slug)); ?>"><i><?php echo e(HTML::image(CATEGORY_FULL_DISPLAY_PATH.$allrecord->category_image,'icon')); ?></i><?php echo e($allrecord->category_name); ?></a>
</li>
...
<li class="nav-item">
<a class="nav-link" href="<?php echo e(URL::to('products/search')); ?>">Category</a>
</li>

<li class="nav-item">
<a class="nav-link" href="<?php echo e(URL::to('merchants/dashboard')); ?>">merchant dashboard</a>
</li>-->
<li class="nav-item mobile_sh">
<a class="nav-link" href="#">How it Works</a>
</li>
<li class="nav-item mobile_sh">
<a class="nav-link" href="<?php echo e(URL::to('/merchant/register')); ?>">List your Business</a>
</li>
<?php if(session()->has('user_id')): ?>
<li class="nav-item mobile_sh">
...
<li class="nav-item mobile_sh">
<a class="nav-link" href="<?php echo e(URL::to('users/dashboard')); ?>">My Account</a>
</li>
<?php else: ?>
<li class="nav-item mobile_sh">
...
<li class="nav-item mobile_sh">
<a class="nav-link" href="<?php echo e(URL::to('register')); ?>">Sign Up</a>
</li>
<?php endif; ?>
</ul>
</div>
...
//    }
 ...
 <?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/elements/header.blade.php ENDPATH**/ ?>