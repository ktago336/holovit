                            ...
                            <?php echo e(Form::open(array('method' => 'post', 'id' => 'registerform', 'class' => 'form form-signin'))); ?>
                                ...
                                <div class="form-group"> 
                                    <div class="Groupon_clone">
                                        ...
                                        <?php echo e(Form::text('busineess_name', null, ['id'=>'busineess_name', 'class'=>'form-control required validname', 'placeholder'=>'Enter business name', 'autocomplete'=>'OFF'])); ?>
								...
								<div class="form-group"> 
                                    <div class="Groupon_clone">
                                        ...
                                        <?php echo e(Form::text('name', null, ['id'=>'name', 'class'=>'form-control required validname', 'placeholder'=>'Enter your name', 'autocomplete'=>'OFF'])); ?>
								...
								<div class="form-group"> 
                                    <div class="Groupon_clone">
                                       <i class="fa fa-phone" aria-hidden="true"></i>
                                        <?php echo e(Form::text('contact', null, ['id'=>'verify_contact', 'class'=>'form-control required digits', 'placeholder'=>'Enter your mobile number', 'autocomplete'=>'OFF'])); ?>
								  ...
								  <div class="form-group"> 
                                    <div class="Groupon_clone">
                                        ...
                                        <?php echo e(Form::text('email_address', Cookie::get('user_email_address'), ['class'=>'form-control required email', 'placeholder'=>'Enter your Email ID', 'autocomplete'=>'OFF'])); ?>
                               ...
                               <div class="form-group"> 
                                    <div class="Groupon_clone">
									   ...
									   <div class="merchant-select">
										<span>
                                        <?php echo e(Form::select('source_of_info_about_us', $how_you_hear_about_us, null, ['id'=>'last_name', 'class'=>'form-control required', 'placeholder'=>'How did you hear about '.SITE_TITLE.'?', 'autocomplete'=>'OFF'])); ?>
                                ...
                                <div class="form-group">
                                    <div class="Groupon_clone_button">
                                        ...
                                        <div class="sin-txt">Already have an account? <a href="<?php echo e(URL('/merchant/login')); ?>">Sign In</a></div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.merchant_inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/merchant/user/register.blade.php ENDPATH**/ ?>