                ...
                <div class="container-login">
                    <div class="login-part">
                        ...
                        <div class="login-form">
                            <?php echo e(Form::open(array('url' => '/merchant/forgot-password', 'method' => 'post', 'id' => 'loginform', 'class' => 'form form-signin'))); ?>
                               ...
                               <div class="form-group">
                                    <div class="Groupon_clone_button">
                                        ...
                                        <div class="create-acc">Already Have an Account? <a href="<?php echo e(url('/merchant/login')); ?>">Login</a></div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.merchant_inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lscouponslogicsp/public_html/resources/views/merchant/user/forgotPassword.blade.php ENDPATH**/ ?>