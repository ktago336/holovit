            ...
            <section id="no-more-tables" class="lstng-section">
                ...
                <table class="table table-bordered table-striped table-condensed cf">
                    <thead class="cf ddpagingshorting">
                        <tr>
                            <th style="width:5%">#</th>
                            <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('category_name', 'Category Name'));?></th>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $allrecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td data-title="Category Name"><?php echo e($allrecord->category_name); ?></td>
                               ...
                               <a href="<?php echo e(URL::to( 'admin/categories/subcategories/'.$allrecord->slug)); ?>" title="Sub Category List" class="btn btn-warning btn-xs" ><i class="fa fa-plus"></i></a>
                                </td>
                            </tr>
...
<?php endif; ?>
<?php /**PATH /home/holovitr/domains/holovit.ru/public_html/resources/views/elements/admin/categories/index.blade.php ENDPATH**/ ?>