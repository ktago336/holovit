		...
		<div class="table_responsive">
                <div class="table_dcf">
                    <div class="tr_tables">
						...
						<div class="td_tables"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('voucher_number', 'Voucher ID'));?></div>
                        ...
                        <div class="td_tables"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('created_at', 'Created On'));?></div>
...
<input type="checkbox" onclick="javascript:isAllSelect(this.form);" name="chkRecordId[]" value="<?php echo e($order->id); ?>" />
											...
											<div data-title="Action" class="td_tables2">
												 ...
												 <?php //} ?>
                                                            <a href="<?php echo e(URL('/users/orderdetail/'.$order->slug)); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i></a>  
...
<?php endif; ?><?php /**PATH /home/lscouponslogicsp/public_html/resources/views/elements/users/myorders.blade.php ENDPATH**/ ?>