                        ...
                        <div class="tab-pane" id="2">
                            <div class="add_deal">
                                <div class="informetion_top">
                                    ...
                                    <?php echo e(Form::open(array('method' => 'post', 'id' => 'serviceForm', 'enctype' => "multipart/form-data"))); ?>
								...
								<?php endif; ?>
									<input type = "hidden" name="merchant_id" value="<?php echo $user_id; ?>">
									 <!--<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo e(Form::text('address', null, ['class'=>'form-control required', 'placeholder'=>'Merchant Address', 'autocomplete' => 'off'])); ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo e(Form::select('amenitie_id[]',$amenitie, null, ['empty'=>'Select Amenities','class'=>'form-control ','multiple'=>'multiple', 'autocomplete' => 'off'])); ?>
                                   ...
                                   <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo e(Form::text('discount', 0, ['class'=>'form-control required number', 'min'=>'1','max'=>'99', 'placeholder'=>'Discount', 'id'=>'discount', 'autocomplete' => 'off','onkeyup' => 'getprice()'])); ?>
...
<?php echo $__env->make('layouts.merchant_inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lscouponslogicsp/public_html/resources/views/merchant/deals/add.blade.php ENDPATH**/ ?>